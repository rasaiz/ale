...
<ul class="display hidden-xs pull-left">
    ...
    <li id="grid"><a rel="nofollow" href="javascript:void(0)" title="{l s='Grid'}"><i class="icons-grid"></i></a></li>
    <li id="list"><a rel="nofollow" href="javascript:void(0)" title="{l s='List'}"><i class="icon icon-align-justify"></i></a></li>
</ul>
