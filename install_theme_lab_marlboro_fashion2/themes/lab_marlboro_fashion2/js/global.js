		...
		$('.product_list > li').each(function(index, element) {
			...
			html += '<div class="center-block col-xs-8 col-sm-7 col-md-8">';
				...
				html += '<div class="lab-button-container media-body">';
					html += '<ul class="add-to-links pull-left">' ;
						html += '<li class="lab-Wishlist">' + $(element).find('.lab-Wishlist').html() + '</li>';
						html += '<li class="lab-compare">' + $(element).find('.lab-compare').html() + '</li>';
					html += '</ul>';
				html += '</div>';
			html += '</div>';
			$(element).html(html);
