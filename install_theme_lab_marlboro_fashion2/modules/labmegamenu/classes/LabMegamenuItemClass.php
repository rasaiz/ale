...
class LabMegamenuItemClass extends ObjectModel
{
	public $id_column;
	public $type_link;
	public $type_item;
	...
	public	function __construct($id_item = null, $id_lang = null, $id_shop = null, Context $context = null)
	{
		...
		Shop::addTableAssociation('labmegamenu_item', array('type' => 'shop'));
		Shop::addTableAssociation('labmegamenu_item_lang', array('type' => 'fk_shop'));
		if ($this->id)
		{
	...
	public function getFieldShop($field)
	{
		...
		$sql = 'SELECT wms.'.$field.' FROM '._DB_PREFIX_.'labmegamenu_item wm
		LEFT JOIN '._DB_PREFIX_.'labmegamenu_item_shop wms ON (wm.id_item = wms.id_item)
