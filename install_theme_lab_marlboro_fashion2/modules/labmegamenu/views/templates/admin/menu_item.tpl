...
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Menu Item' mod='labmegamenu'}</h3>
	<div class="form-wrapper" id="menuContent" >
		<div class="form-group lab-type-link">
			<label class="control-label col-lg-3">{l s='Type Link' mod='labmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group lab-menu-title" {if $menu->type_link == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Title' mod='labmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group lab-menu-link" {if $menu->type_link == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Link' mod='labmegamenu'}</label>
			<div class="col-lg-9">
				{foreach from=$languages item=language}
					{if $languages|count > 1}
						<div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
		...
		<div class="form-group ps_link" {if $menu->type_link == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='PrestaShop Link' mod='labmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group show_sub" {if $menu->type_link == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Show Sub Categories' mod='labmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group">
			<label class="control-label col-lg-3">{l s='Sub Title' mod='labmegamenu'}</label>
			<div class="col-lg-9">
				{foreach from=$languages item=language}
					{if $languages|count > 1}
						<div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
		...
		<div class="form-group lab-type-icon">
			<label class="control-label col-lg-3">{l s='Type Icon' mod='labmegamenu'}</label>
			<div class="col-lg-9">
				<div class="radio lab-radio">
		...
		<div class="form-group lab-fw-icon" {if $menu->type_icon == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Font-Awesome Icon' mod='labmegamenu'}</label>
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Font-Awesome at :' mod='labmegamenu'} <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/">http://fortawesome.github.io/Font-Awesome/3.2.1/icons/.</a> ex: icon-sun</p>
			</div>
		</div>
		<div class="form-group lab-img-icon" {if $menu->type_icon == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Image Icon' mod='labmegamenu'}</label>
			<div class="col-lg-9">
				<div class="col-lg-6">
	...
	<div class="form-group">
		...
		<div class="col-lg-9">
			<select class="form-control fixed-width-lg" name="align_sub" id="align_sub">
				<option value="lab-sub-left">{l s='Left' mod='labmegamenu'}</option>
				<option value="lab-sub-right">{l s='Right' mod='labmegamenu'}</option>
				<option value="lab-sub-center">{l s='Center' mod='labmegamenu'}</option>
				<option value="lab-sub-auto">{l s='Auto' mod='labmegamenu'}</option>
			</select>
			<script type="text/javascript">
				$(document).ready(function(){
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Width Of SubMenu' mod='labmegamenu'}</label>
		<div class="col-lg-9">
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Class' mod='labmegamenu'}</label>
		<div class="col-lg-9">
			<input type="text" class="class" id="class" name="class" value="{if $menu->class}{$menu->class|escape:'html':'UTF-8'}{/if}"/>
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Active' mod='labmegamenu'}</label>
		<div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
