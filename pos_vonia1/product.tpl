												...
												<div class="actions">
													<div class="actions-inner">
														<ul class="add-to-links">
															...
															{/if}
															<li>
																<a class="addToWishlist wishlistProd_{$accessory.id_product|intval}" title="{l s='Add to Wishlist'}"  href="#" data-wishlist="{$accessory.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$accessory.id_product|intval}', false, 1); return false;">
															...
															<li>
																...
																{if isset($comparator_max_item) && $comparator_max_item}
																  <a class="add_to_compare" title="{l s='Add to Compare'}" href="{$accessory.link|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product}">{l s='Add to Compare'}
