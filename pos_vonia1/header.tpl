...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
		...
		{if isset($js_defer) && !$js_defer && isset($js_files) && isset($js_def)}
			...
			{/foreach}
		{/if}
		<script async src="{$js_dir}owl.carousel.js" type="text/javascript" ></script>
		{$HOOK_HEADER}
		<!--[if IE 8]>
		...
		<div id="page"{if $page_name !="index"} class="sub-page"{/if}>
			<div class="header-container">
				<header id="header">
					...
					<div class="header-middle">
						<div class="container">
							<div class="row">
								<div class="pos_logo col-md-offset-4 col-lg-offset-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
			...
			<div class="columns-container">
				<div id="columns" class="container">
					...
					{if $page_name !='index' && $page_name !='pagenotfound' && $page_name !='contact' && $page_name !='stores'}
