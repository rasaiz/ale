							...
							<div class="actions">
								<div class="actions-inner">
									...
									<ul class="add-to-links">
										...
										<li>
											<a class="addToWishlist wishlistProd_{$product.id_product|intval}" href="#" data-wishlist="{$product.id_product|intval}" title="{l s='Add to Wishlist'}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1); return false;">
